...
insert into nodes (n_name,n_ip,n_model,n_group,n_username,n_password,n_enabled,n_location) VALUEs ('TestNode','192.168.1.1','cisco','cisco','cisco','cisco',True,'Delete This Row');
EOF
